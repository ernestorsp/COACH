...
function ensureUI(){
 ...
 <div class="row" style="margin-top:14px"><button class="btn blue liveStation" data-st="DJX3">DJX3</button><button class="btn soft liveStation" data-st="DJX4">DJX4</button><button class="btn soft" id="liveSettings">⚙ Deadlines</button></div>
 ...
 document.querySelectorAll('.liveStation').forEach(x=>x.onclick=()=>{window._coachStation=x.dataset.st;document.querySelectorAll('.liveStation').forEach(y=>y.className='btn '+(y===x?'blue':'soft'));render()});
