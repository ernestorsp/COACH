...
function ensureLiveEffects(){
 ...
 .coachSweep{display:block!important;position:absolute!important;z-index:20!important;top:-55%!important;left:-32%!important;width:18%!important;height:220%!important;pointer-events:none!important;background:linear-gradient(90deg,transparent,rgba(255,255,255,.18),rgba(255,255,255,.98),rgba(255,255,255,.18),transparent)!important;box-shadow:0 0 28px rgba(255,255,255,.75)!important;transform:translateX(0) rotate(18deg);will-change:transform}
 `;
...
function render(){
 ...
 document.querySelectorAll('#liveList .coachRouteActive .coachSweep').forEach(el=>{
   try{
     el.getAnimations().forEach(a=>a.cancel());
     el.animate(
       [{transform:'translateX(0) rotate(18deg)',opacity:.15},{opacity:1,offset:.12},{transform:'translateX(760%) rotate(18deg)',opacity:.15}],
